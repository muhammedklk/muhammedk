...
import { AboutIntro, ContactTeaser, FAQ, Hero, Process, SelectedWork, Services, SkillsMarquee, Stats } from "@/components/portfolio/Sections";
...
function Home(){return <><Hero/><AboutIntro/><SelectedWork limit={3}/><Process/><SkillsMarquee/><Stats/><Services/><FAQ/><ContactTeaser/></>}