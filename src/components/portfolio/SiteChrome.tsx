  ...
  return (
    <>
      <header className={`site-header ${scrolled ? "is-scrolled" : ""}`}>
        <Link to="/" className="wordmark" aria-label="Muhammed K home">
          MUHAMMED K
        </Link>
      ...
      <div id="site-menu" className={`menu-overlay ${open ? "is-open" : ""}`} aria-hidden={!open}>
        ...
        <aside>
          ...
          <a className="social-link menu-resume" href="/muhammed-k-resume.pdf" download="Muhammed-K-Resume.pdf">
            <Download />
            RESUME / CV
          </a>
          <p className="eyebrow menu-email-label">EMAIL</p>
...
export function CustomCursor() {
  ...
  useEffect(() => {
    ...
    const over = (e: MouseEvent) => {
      ...
      const mode: string =
        ...
        (target.closest("a,button") ? "link" : "");
      dot.current?.setAttribute("data-mode", mode);
      if (label.current) label.current.textContent = mode === "view" ? "VIEW" : "";
    };
  ...
  return (
    <div ref={dot} className="custom-cursor" aria-hidden="true">
      <span ref={label} />
    </div>
  );
}
      ...
      <div className="footer-top">
        ...
        <div className="footer-links">
          ...
          <div className="footer-social">
            ...
            <a href="/muhammed-k-resume.pdf" download="Muhammed-K-Resume.pdf" aria-label="Download resume">
              <Download />
            </a>
          </div>
        </div>
