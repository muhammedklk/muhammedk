...
export function Footer(){return <footer className="site-footer"><div className="footer-top"><p>MUHAMMED K</p><p>UI/UX DESIGNER<br/>FRONT-END DEVELOPER</p><div className="footer-links"><nav>{nav.map(n=><Link key={n.to} to={n.to}>{n.label}</Link>)}<Link to="/admin" style={{ opacity: 0.6 }}>ADMIN</Link></nav><div className="footer-social"><a href="https://www.linkedin.com" target="_blank" rel="noreferrer" aria-label="LinkedIn"><Linkedin/></a><a href="https://github.com" target="_blank" rel="noreferrer" aria-label="GitHub"><Github/></a><a href="https://www.instagram.com" target="_blank" rel="noreferrer" aria-label="Instagram"><Instagram/></a><a href="/muhammed-k-resume.pdf" download="Muhammed-K-Resume.pdf" aria-label="Download resume"><Download/></a></div></div></div><div className="footer-big" aria-hidden="true">MK</div><div className="footer-bottom"><span>© 2026 MUHAMMED K</span><span>KERALA, INDIA</span><Link to="/admin" style={{ opacity: 0.5 }}>ADMIN PANEL ↗</Link><a href="#top">BACK TO TOP ↑</a></div></footer>}

export function SiteLayout({children}:{children:ReactNode}){const pathname=useRouterState({select:s=>s.location.pathname});return <><Header/><CustomCursor/><main key={pathname} id="top" className="page-enter">{children}</main><Footer/></>}